...
assert -name {inv - stream buffer status} \
{ ( \
...
assert -name {inv - valid in stream pointer} \
{ ( \
...
#
assert -name {inv - valid slice stream pointer} \
{ ( \
...
#
assert -name {inv - valid stencil stream pointer} \
{ ( \
