...
(synth-fun INV ((|wrapper_is| Bool) (|__ILA_I_en| Bool) (|__ILA_SO_v| (_ BitVec 4)) (|m1.imp| (_ BitVec 4)) (|m1.v| (_ BitVec 4)) (|clk| Bool) (|rst| Bool)) Bool
  ((Start Bool (Conj))
   (Conj Bool (Clause
               (and Clause Conj)))
   (Clause Bool (Atom
 ...
 (Exp4 (_ BitVec 4) ( VarOrVal4
                      (bvadd VarOrVal4 VarOrVal4)
                      (bvsub VarOrVal4 VarOrVal4)
                      (bvand VarOrVal4 VarOrVal4)
                      (bvor VarOrVal4 VarOrVal4)
                      (bvneg VarOrVal4)
                      (bvnot VarOrVal4)))
...
(define-fun |wrapper#3| ((|wrapper_is| Bool) (|wrapper#0| Bool) (|wrapper#1| (_ BitVec 4)) (|wrapper#2| (_ BitVec 4)) (|wrapper#4| (_ BitVec 4)) (|wrapper#8| Bool) (|wrapper#11| Bool)) Bool (= |wrapper#2| #b0010)) ;  $eq$/home/hongce/ila/ILA-Tools/test/unit-data/inv_syn/cnt2-sygus-tf/inv-syn-sygus/wrapper.v:37$1_Y
(define-fun |wrapper#5| ((|wrapper_is| Bool) (|wrapper#0| Bool) (|wrapper#1| (_ BitVec 4)) (|wrapper#2| (_ BitVec 4)) (|wrapper#4| (_ BitVec 4)) (|wrapper#8| Bool) (|wrapper#11| Bool)) Bool (= |wrapper#4| #b0010)) ;  $eq$/home/hongce/ila/ILA-Tools/test/unit-data/inv_syn/cnt2-sygus-tf/inv-syn-sygus/wrapper.v:37$3_Y
(define-fun |wrapper#6| ((|wrapper_is| Bool) (|wrapper#0| Bool) (|wrapper#1| (_ BitVec 4)) (|wrapper#2| (_ BitVec 4)) (|wrapper#4| (_ BitVec 4)) (|wrapper#8| Bool) (|wrapper#11| Bool)) Bool (and (or  (|wrapper#3| |wrapper_is| |wrapper#0| |wrapper#1| |wrapper#2| |wrapper#4| |wrapper#8| |wrapper#11|) false) (or  (|wrapper#5| |wrapper_is| |wrapper#0| |wrapper#1| |wrapper#2| |wrapper#4| |wrapper#8| |wrapper#11|) false))) ;  $logic_and$/home/hongce/ila/ILA-Tools/test/unit-data/inv_syn/cnt2-sygus-tf/inv-syn-sygus/wrapper.v:37$4_Y
...
(define-fun |wrapper#9| ((|wrapper_is| Bool) (|wrapper#0| Bool) (|wrapper#1| (_ BitVec 4)) (|wrapper#2| (_ BitVec 4)) (|wrapper#4| (_ BitVec 4)) (|wrapper#8| Bool) (|wrapper#11| Bool)) (_ BitVec 4) (bvsub #b1111 |wrapper#2|)) ;  $techmap\m1.$sub$/home/hongce/ila/ILA-Tools/test/unit-data/inv_syn/cnt2-sygus-tf/inv-syn-sygus/wrapper.v:72$11_Y
...
; yosys-smt2-assert 0 /home/hongce/ila/ILA-Tools/test/unit-data/inv_syn/cnt2-sygus-tf/inv-syn-sygus/wrapper.v:47
(define-fun |wrapper_a 0| ((|wrapper_is| Bool) (|wrapper#0| Bool) (|wrapper#1| (_ BitVec 4)) (|wrapper#2| (_ BitVec 4)) (|wrapper#4| (_ BitVec 4)) (|wrapper#8| Bool) (|wrapper#11| Bool)) Bool (or (= ((_ extract 0 0) (|wrapper#7| |wrapper_is| |wrapper#0| |wrapper#1| |wrapper#2| |wrapper#4| |wrapper#8| |wrapper#11|)) #b1) (not true))) ;  $assert$/home/hongce/ila/ILA-Tools/test/unit-data/inv_syn/cnt2-sygus-tf/inv-syn-sygus/wrapper.v:47$6
(define-fun |wrapper#12| ((|wrapper_is| Bool) (|wrapper#0| Bool) (|wrapper#1| (_ BitVec 4)) (|wrapper#2| (_ BitVec 4)) (|wrapper#4| (_ BitVec 4)) (|wrapper#8| Bool) (|wrapper#11| Bool)) (_ BitVec 4) (bvadd |wrapper#4| #b0001)) ;  $techmap\m1.$add$/home/hongce/ila/ILA-Tools/test/unit-data/inv_syn/cnt2-sygus-tf/inv-syn-sygus/wrapper.v:62$8_Y
...
(constraint (=> (and 
  ...
  (|wrapper_h| |BI_wrapper_is| |BI___ILA_I_en| |BI___ILA_SO_v| |BI_m1.imp| |BI_m1.v| |BI_clk| |BI_rst|)
  (|wrapper_h| |I_wrapper_is| |I___ILA_I_en| |I___ILA_SO_v| |I_m1.imp| |I_m1.v| |I_clk| |I_rst|)
...
(constraint (=> (and 
  ...
  (|wrapper_h| |S_wrapper_is| |S___ILA_I_en| |S___ILA_SO_v| |S_m1.imp| |S_m1.v| |S_clk| |S_rst|)
  (|wrapper_h| |S'_wrapper_is| |S'___ILA_I_en| |S'___ILA_SO_v| |S'_m1.imp| |S'_m1.v| |S'_clk| |S'_rst|)
...
(constraint (=> (and 
  ...
  (|wrapper_u| |S_wrapper_is| |S___ILA_I_en| |S___ILA_SO_v| |S_m1.imp| |S_m1.v| |S_clk| |S_rst|) 
  (|wrapper_h| |S_wrapper_is| |S___ILA_I_en| |S___ILA_SO_v| |S_m1.imp| |S_m1.v| |S_clk| |S_rst|))
  (|wrapper_a| |S_wrapper_is| |S___ILA_I_en| |S___ILA_SO_v| |S_m1.imp| |S_m1.v| |S_clk| |S_rst|)))
